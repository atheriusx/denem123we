...
module.exports = {
  name: "clean",
  description: "Permet de clean la DB",
  ...
  run: async (client, interaction, args) => {
    ...
    await interaction.reply({embeds: [new discord.MessageEmbed().setDescription(`**Suppression des membres invalide en cours...**`)]})
    ...
    interaction.editReply({
      embeds: [{
          title: "Membres supprimés de la DB",
          description: `**${count} Membres supprimés**`,
      }],
  });
  }
}
